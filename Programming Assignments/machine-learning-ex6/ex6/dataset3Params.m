...
[err, index] = min(results(:,3)); % use the min() function on the results matrix to find

C = results(index,1);
sigma = results(index,2); % the C and sigma values that give the lowest validation error
